...
|--------|------|----------|
| ✅ PASS | ~~SKILL.md has valid frontmatter~~ | `head -20 skills/checklist-runner/SKILL.md` contains `name:` and `description:` |
...
---
*Generated by [checklist-runner](https://github.com/VdustR/skills)*
```
